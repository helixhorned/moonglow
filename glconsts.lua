...
static const int ALL_ATTRIB_BITS = 0xFFFFFFFF;
...
static const int GLEXT_VERSION = 20190805;
...
static const int CONTEXT_FLAG_FORWARD_COMPATIBLE_BIT = 0x00000001;
...
static const int COLOR_ATTACHMENT16 = 0x8CF0;
static const int COLOR_ATTACHMENT17 = 0x8CF1;
static const int COLOR_ATTACHMENT18 = 0x8CF2;
static const int COLOR_ATTACHMENT19 = 0x8CF3;
static const int COLOR_ATTACHMENT20 = 0x8CF4;
static const int COLOR_ATTACHMENT21 = 0x8CF5;
static const int COLOR_ATTACHMENT22 = 0x8CF6;
static const int COLOR_ATTACHMENT23 = 0x8CF7;
static const int COLOR_ATTACHMENT24 = 0x8CF8;
static const int COLOR_ATTACHMENT25 = 0x8CF9;
static const int COLOR_ATTACHMENT26 = 0x8CFA;
static const int COLOR_ATTACHMENT27 = 0x8CFB;
static const int COLOR_ATTACHMENT28 = 0x8CFC;
static const int COLOR_ATTACHMENT29 = 0x8CFD;
static const int COLOR_ATTACHMENT30 = 0x8CFE;
static const int COLOR_ATTACHMENT31 = 0x8CFF;
...
static const int TRANSFORM_FEEDBACK_BUFFER_PAUSED = 0x8E23;
static const int TRANSFORM_FEEDBACK_BUFFER_ACTIVE = 0x8E24;
...
static const int COMPRESSED_RGBA_BPTC_UNORM = 0x8E8C;
static const int COMPRESSED_SRGB_ALPHA_BPTC_UNORM = 0x8E8D;
static const int COMPRESSED_RGB_BPTC_SIGNED_FLOAT = 0x8E8E;
static const int COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT = 0x8E8F;
...
static const int MAX_COMPUTE_WORK_GROUP_INVOCATIONS = 0x90EB;
static const int MAX_COMPUTE_WORK_GROUP_COUNT = 0x91BE;
static const int MAX_COMPUTE_WORK_GROUP_SIZE = 0x91BF;
static const int COMPUTE_WORK_GROUP_SIZE = 0x8267;
...
static const int SHADER_STORAGE_BARRIER_BIT = 0x00002000;
static const int MAX_COMBINED_SHADER_OUTPUT_RESOURCES = 0x8F39;
...
static const int VERTEX_BINDING_BUFFER = 0x8F4F;
static const int DISPLAY_LIST = 0x82E7;
static const int MAX_VERTEX_ATTRIB_STRIDE = 0x82E5;
static const int PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED = 0x8221;
static const int TEXTURE_BUFFER_BINDING = 0x8C2A;
static const int MAP_PERSISTENT_BIT = 0x0040;
static const int MAP_COHERENT_BIT = 0x0080;
static const int DYNAMIC_STORAGE_BIT = 0x0100;
static const int CLIENT_STORAGE_BIT = 0x0200;
static const int CLIENT_MAPPED_BUFFER_BARRIER_BIT = 0x00004000;
static const int BUFFER_IMMUTABLE_STORAGE = 0x821F;
static const int BUFFER_STORAGE_FLAGS = 0x8220;
static const int CLEAR_TEXTURE = 0x9365;
static const int LOCATION_COMPONENT = 0x934A;
static const int TRANSFORM_FEEDBACK_BUFFER_INDEX = 0x934B;
static const int TRANSFORM_FEEDBACK_BUFFER_STRIDE = 0x934C;
static const int QUERY_BUFFER = 0x9192;
static const int QUERY_BUFFER_BARRIER_BIT = 0x00008000;
static const int QUERY_BUFFER_BINDING = 0x9193;
static const int QUERY_RESULT_NO_WAIT = 0x9194;
static const int MIRROR_CLAMP_TO_EDGE = 0x8743;
static const int CONTEXT_LOST = 0x0507;
static const int NEGATIVE_ONE_TO_ONE = 0x935E;
static const int ZERO_TO_ONE = 0x935F;
static const int CLIP_ORIGIN = 0x935C;
static const int CLIP_DEPTH_MODE = 0x935D;
static const int QUERY_WAIT_INVERTED = 0x8E17;
static const int QUERY_NO_WAIT_INVERTED = 0x8E18;
static const int QUERY_BY_REGION_WAIT_INVERTED = 0x8E19;
static const int QUERY_BY_REGION_NO_WAIT_INVERTED = 0x8E1A;
static const int MAX_CULL_DISTANCES = 0x82F9;
static const int MAX_COMBINED_CLIP_AND_CULL_DISTANCES = 0x82FA;
static const int TEXTURE_TARGET = 0x1006;
static const int QUERY_TARGET = 0x82EA;
static const int GUILTY_CONTEXT_RESET = 0x8253;
static const int INNOCENT_CONTEXT_RESET = 0x8254;
static const int UNKNOWN_CONTEXT_RESET = 0x8255;
static const int RESET_NOTIFICATION_STRATEGY = 0x8256;
static const int LOSE_CONTEXT_ON_RESET = 0x8252;
static const int NO_RESET_NOTIFICATION = 0x8261;
static const int CONTEXT_FLAG_ROBUST_ACCESS_BIT = 0x00000004;
static const int CONTEXT_RELEASE_BEHAVIOR = 0x82FB;
static const int CONTEXT_RELEASE_BEHAVIOR_FLUSH = 0x82FC;
static const int SHADER_BINARY_FORMAT_SPIR_V = 0x9551;
static const int SPIR_V_BINARY = 0x9552;
static const int PARAMETER_BUFFER = 0x80EE;
static const int PARAMETER_BUFFER_BINDING = 0x80EF;
static const int CONTEXT_FLAG_NO_ERROR_BIT = 0x00000008;
static const int VERTICES_SUBMITTED = 0x82EE;
static const int PRIMITIVES_SUBMITTED = 0x82EF;
static const int VERTEX_SHADER_INVOCATIONS = 0x82F0;
static const int TESS_CONTROL_SHADER_PATCHES = 0x82F1;
static const int TESS_EVALUATION_SHADER_INVOCATIONS = 0x82F2;
static const int GEOMETRY_SHADER_PRIMITIVES_EMITTED = 0x82F3;
static const int FRAGMENT_SHADER_INVOCATIONS = 0x82F4;
static const int COMPUTE_SHADER_INVOCATIONS = 0x82F5;
static const int CLIPPING_INPUT_PRIMITIVES = 0x82F6;
static const int CLIPPING_OUTPUT_PRIMITIVES = 0x82F7;
static const int POLYGON_OFFSET_CLAMP = 0x8E1B;
static const int TEXTURE_MAX_ANISOTROPY = 0x84FE;
static const int MAX_TEXTURE_MAX_ANISOTROPY = 0x84FF;
static const int TRANSFORM_FEEDBACK_OVERFLOW = 0x82EC;
static const int TRANSFORM_FEEDBACK_STREAM_OVERFLOW = 0x82ED;
static const int VIEW_CLASS_EAC_R11 = 0x9383;
static const int VIEW_CLASS_EAC_RG11 = 0x9384;
static const int VIEW_CLASS_ETC2_RGB = 0x9385;
static const int VIEW_CLASS_ETC2_RGBA = 0x9386;
static const int VIEW_CLASS_ETC2_EAC_RGBA = 0x9387;
static const int VIEW_CLASS_ASTC_4x4_RGBA = 0x9388;
static const int VIEW_CLASS_ASTC_5x4_RGBA = 0x9389;
static const int VIEW_CLASS_ASTC_5x5_RGBA = 0x938A;
static const int VIEW_CLASS_ASTC_6x5_RGBA = 0x938B;
static const int VIEW_CLASS_ASTC_6x6_RGBA = 0x938C;
static const int VIEW_CLASS_ASTC_8x5_RGBA = 0x938D;
static const int VIEW_CLASS_ASTC_8x6_RGBA = 0x938E;
static const int VIEW_CLASS_ASTC_8x8_RGBA = 0x938F;
static const int VIEW_CLASS_ASTC_10x5_RGBA = 0x9390;
static const int VIEW_CLASS_ASTC_10x6_RGBA = 0x9391;
static const int VIEW_CLASS_ASTC_10x8_RGBA = 0x9392;
static const int VIEW_CLASS_ASTC_10x10_RGBA = 0x9393;
static const int VIEW_CLASS_ASTC_12x10_RGBA = 0x9394;
static const int VIEW_CLASS_ASTC_12x12_RGBA = 0x9395;
static const int CONTEXT_ROBUST_ACCESS = 0x90F3;
...
static const int OVR_multiview = 1;
static const int FRAMEBUFFER_ATTACHMENT_TEXTURE_NUM_VIEWS_OVR = 0x9630;
static const int FRAMEBUFFER_ATTACHMENT_TEXTURE_BASE_VIEW_INDEX_OVR = 0x9632;
static const int MAX_VIEWS_OVR = 0x9631;
static const int FRAMEBUFFER_INCOMPLETE_VIEW_TARGETS_OVR = 0x9633;
static const int OVR_multiview2 = 1;
}]])
